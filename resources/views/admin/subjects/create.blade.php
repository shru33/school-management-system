<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Create New Subject') }}</h2>
                    ...
                    <form action="{{ route('admin.subjects.store') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="credits" id="credits" value="{{ old('credits', 1) }}" required min="1"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200">
                            </div>
                        ...
                        <div class="mt-6 flex justify-end gap-4">
                            ...
                            <button type="submit" 
                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Create Subject</button>
                        </div>
                    </form>
                </div>
            </div>
